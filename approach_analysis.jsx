...
const approaches = [
  {
    ...
    color: "#6B7280",
    recommended: false,
    summary: "Standard .NET Clean Architecture with EF Core, SQL Server, service layer. No V17 involvement. Safe, expected, forgettable.",
    phases: [
  ...
  },
  {
    ...
    subtitle: "V17 philosophy, traditional tech stack",
    time: "5-7h",
    risk: "Low",
    meetsReqs: true,
    seniorThinking: true,
    ...
    color: "#3B82F6",
    recommended: false,
    summary: "Uses SQL Server + EF Core as required, but designs the workflow engine as a generic state machine following Freedom Machine philosophy. Shows architectural vision.",
    phases: [
  ...
  },
  {
    ...
    color: "#10B981",
    recommended: true,
    summary: "Delivers exactly what's asked (SQL Server, EF Core, clean arch) with a hidden V17-inspired generic engine underneath. Evaluator sees standard code + architectural depth.",
    phases: [
            ...
            [
              ...
              ...row.vals.map((v, vi) => (
                <div key={`v-${ri}-${vi}`} style={{
                  ...
                  textAlign: "center",
                  fontWeight: 600,
                  color: v === "✗" || v === "High" || v === "Yes*" ? "#EF4444" : "#374151",
